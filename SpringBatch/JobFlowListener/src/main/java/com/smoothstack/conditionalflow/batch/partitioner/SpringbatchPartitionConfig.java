package com.smoothstack.conditionalflow.batch.partitioner;
...
public class SpringbatchPartitionConfig {
    ...
    public Step slaveStep() throws UnexpectedInputException, MalformedURLException, ParseException {
        return steps.get("slaveStep")
          ...
          .writer(itemWriter1(marshaller1(), null))
          .build();
    }
    ...
    @Bean(destroyMethod = "")
    @StepScope
    public StaxEventItemWriter<Transaction> itemWriter1(Marshaller marshaller, @Value("#{stepExecutionContext[opFileName]}") String filename) throws MalformedURLException {
